...
public class PlayerCubeManager : MonoBehaviour
{
    ...
    private float groundValue = -0.0602f;
    ...
    public void AcceleratePlayer(CubeBehaviour cubeBehaviour)
    {
        PlayerBehaviour.Instance.FastPlayer();
    }

    public void SlowdownPlayer(CubeBehaviour cubeBehaviour)
    {
        PlayerBehaviour.Instance.SlowPlayer();
    }

    public void NormalSpeedPlayer(CubeBehaviour cubeBehaviour)
    {
        PlayerBehaviour.Instance.NormalPlayer();
    }
    ...
    public void DeleteCube(CubeBehaviour cubeBehaviour)
    {
        Debug.Log("DeleteCube - Volcanic");
        cubeBehaviour.transform.parent = null;
        cubeBehaviour.isStacked = false;
